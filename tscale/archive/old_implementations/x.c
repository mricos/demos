#MULTICAT_START
# dir: /Users/mricos/src/mricos/demos/tscale
# file: tscale.c
# notes: Fixes: (1) rename mode_t→filt_mode_t to avoid macOS typedef clash; (2) adapt to miniaudio ma_decoder_read_pcm_frames(..., ma_uint64*); (3) silence CoreAudio deprecation warnings around miniaudio.h.
#MULTICAT_END
