...
export const mat4 = {
     ...
     */
    fromTranslation(v, out = new Float32Array(16)) {
        return mat4.translation(v.x, v.y, v.z, out);
    },
     ...
     * Scaling from vec3
     */
    fromScaling(v, out = new Float32Array(16)) {
        return mat4.scaling(v.x, v.y, v.z, out);
    },
     ...
     */
    compose(translation, rotation, scale, out = new Float32Array(16)) {
