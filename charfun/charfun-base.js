 ...
 *
 * Complex arithmetic imported from /shared/complex.js.
 * UI helpers (resize, play/pause, canvas hover, keyboard) stay local.
 *
 * Loaded as ES module; assigns window.CF for backward compat with inline scripts.
 */
import { complexPow, complexMul } from '/shared/complex.js';
import { createCanvas } from '/shared/canvas.js';

var CF = {};

// ── Math utilities (delegating to shared) ───────────────────
